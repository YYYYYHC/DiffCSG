...
pos = tensor([[[-0.8, -0.8, 0, 1], [0.8, -0.8, 0, 1], [-0.8, 0.8, 0, 1]],[[-0.8, -0.8, 0.1, 1], [0.8, -0.8, 0.1, 1], [-0.8, 0.8, 0.1, 1]]], dtype=torch.float32)
col = tensor([[[0.5, 0, 0], [0, 0.5, 0], [0, 0, 0.5]],[[1, 0, 0], [0, 1, 0], [0, 0, 1]]], dtype=torch.float32)

tri = tensor([[0, 1, 2],[0, 1, 2]], dtype=torch.int32)
pdb.set_trace()
